...
def fetch_all_insights():
    ...
    url_inicial = (
        ...
        "?time_increment=1"
        "&level=ad"
        "&fields=impressions%2Creach%2Cspend%2Cadset_id%2Cadset_name%2Cad_id%2Cad_name%2Cactions"
        "&action_breakdowns=action_type"
        "&access_token=EAARvDNZAUYcEBO4pZCEPUAiWk54zMsCZCkbFhetvWZAhRvhfcG9v6qsHa9a1AyANu0Y3r5ZBr3nUBMvYlujB3kx1iAZCTyjXTRCMqxpRx8Y8KQo8iJgGd99EQkM53UFDQ6QnBofsL4ynWtZBoDiiCVAZBNCIjpwVKhE5cr89tMwDxWL2ojezO5Hxe6Hl6FuSXLDtOPDjd4p78YR9bPWun1zzM5hP2QZDZD"
        "&limit=25"
        "&after=https://graph.facebook.com/v22.0/act_264383791293755/insights?time_increment=1limit:100&level=ad&fields=impressions%2Creach%2Cspend%2Cadset_id%2Cadset_name%2Cad_id%2Cad_name%2Cactions&action_breakdowns=action_type&access_token=EAARvDNZAUYcEBO4pZCEPUAiWk54zMsCZCkbFhetvWZAhRvhfcG9v6qsHa9a1AyANu0Y3r5ZBr3nUBMvYlujB3kx1iAZCTyjXTRCMqxpRx8Y8KQo8iJgGd99EQkM53UFDQ6QnBofsL4ynWtZBoDiiCVAZBNCIjpwVKhE5cr89tMwDxWL2ojezO5Hxe6Hl6FuSXLDtOPDjd4p78YR9bPWun1zzM5hP2QZDZD" # Alterar AQUI com o último After ID que aparecer na URL em que a requisição deu erro
